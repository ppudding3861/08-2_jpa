...
public class A_EntityLifeCycleTests {
    ...
    /**
     * 영속성 컨텍스트는 엔디디 매니저가 엔티티 객체를 저장하는 공간으로 엔티티 객체를 보관하고 관리한다.
    ...
    public void 준영속성_clear_테스트() {
        ...
        foundMenu1.setMenuPrice(232);
        foundMenu2.setMenuPrice(50025250);

        //then
        Assertions.assertNotEquals(232, entityManager.find(Menu.class, 11).getMenuPrice());
        Assertions.assertNotEquals(50025250, entityManager.find(Menu.class, 12).getMenuPrice());
    }
    @Test
