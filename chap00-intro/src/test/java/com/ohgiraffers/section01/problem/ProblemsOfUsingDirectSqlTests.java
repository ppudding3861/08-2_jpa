...
class ProblemsOfUsingDirectSqlTests {
    ...
    // 1. 데이터 변환, sql작성, .jdbc api 코드 등의 중복 작성(개발 시간 증가, 유지보수성 저하)
    ...
    void testDirectSelectSql() throws SQLException {
        ...
        while(rset.next()){
            ...
            menu.setMenuNamel((rset.getString("MENU_NAME")));
    ...
    @DisplayName("직접 SQL을 작성하여 신구 메뉴를 추가할 때 발생하는 문제 확인")
    @Test
    void testDirectInsertSql() throws SQLException {
        Menu menu = new Menu();
        menu.setMenuNamel("민트초코짜장면");
        menu.setMenuPrice(12000);
        menu.setMenuCode(1);
        menu.setOrderableStatus("Y");

        String query = "INSERT INTO TBL_MENU VALUES(MENU_NAME, MENU_PRICE, MENU_CODE, ORDERABLE_STATUS) VALUES(?,?,?,?)";

        PreparedStatement pstmt = con.prepareStatement(query);
        pstmt.setString(1, menu.getMenuNamel());
...
//            menu.setMenuPrice(rset.getInt("MENU_PRICE"));
    ...
    void testEquals() throws SQLException {
        ...
        while(rset1.next()) {
            ...
            menu1.setMenuNamel(rset1.getString("MENU_NAME"));
        }
        ...
        while(rset2.next()) {
            ...
            menu2.setMenuNamel(rset2.getString("MENU_NAME"));
        }
